  ...
  return (
    <section className="relative w-full overflow-hidden  bg-white py-10 sm:py-12 md:py-14 lg:h-[500px] lg:py-0">
      ...
      <img
        src={NotebookIcon}
        alt=""
        className="pointer-events-none absolute right-[14%] top-[82px] z-0 hidden w-[55px] select-none lg:block xl:right-[24%] xl:top-[76px] xl:w-[65px] 
        2xl:right-[27%] 2xl:top-[72px] 2xl:w-[72px]"
      />

      <img
        src={TravelIcon}
        alt=""
        className="pointer-events-none absolute bottom-[20px] left-[18px] z-0
      ...
      <div className="relative z-10 px-4 text-center lg:pt-[48px]">
        {/* Small Heading */}
        <h4 className="font-serif mb-5 text-[22px] font-normal italic leading-none text-[#173F52] sm:text-[24px] md:text-[26px] lg:text-[22px]">
          Wonderful Place For You
        </h4>

        {/* Main Heading */}
        <h2 className="mb-5 text-[34px] font-bold leading-none text-[#173F52] sm:text-[38px] md:text-[42px] lg:text-[40px]">
          Tour Categories
        </h2>
      </div>
